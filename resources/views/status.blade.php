...
-->
    ...
    <section>
        <div class="container ml-5 mt-2">
            <span class="text-muted">products :</span><span>{{$order->user_products}}</span>
            <br>
            <span class="text-muted">totale :</span><span>{{$order->order_totale}}</span>
            <br>
            <span class="text-muted">status :</span><span>{{$order->status}}</span>
            <br>
            <span class="text-muted">placed on :</span><span>{{$order->created_at}}</span>
        </div>
